function treeGen() {
    ...
    $(".gerarchia").fancytree({
            ...
            dragDrop: function (node, data) {
                ...
                $('.ok').click(function () {
                    node.setExpanded(true).always(function () {
                        ...
                        $.ajax({
                            url: Glizy.ajaxUrl + '&controllerName=metafad.tei.controllers.ajax.ModifyTree',
                            type: 'get',
                            action: 'modify',
                            dataType: 'json',
                            data: {
        ...
        source: $.ajax({
            url: Glizy.ajaxUrl + '&controllerName=metafad.tei.controllers.ajax.GetTree',
            type: 'get',
            dataType: 'json',
            data: {
                id: id,
        ...
        lazyLoad: function (event, data) {
            ...
            data.result =
                $.ajax({
                    url: Glizy.ajaxUrl + '&controllerName=metafad.tei.controllers.ajax.GetTreeFromParent',
                    type: 'get',
                    dataType: 'json',
                    data: {
                        id: node.data.id
        ...
        renderNode: function (event, data) {
            ...
            addButton.click(function () {
                ...
                if (id) {
                    ...
                    var parentId = data.node.data.id;
                    $.ajax({
                        url: Glizy.ajaxUrl + '&controllerName=metafad.tei.controllers.ajax.GetLevelType',
                        type: 'get',
                        dataType: 'json',
                        data: {
                            id: parentId,
            ...
            deleteButton.click(function () {
                ...
                $('.ok').click(function () {
                    ...
                    $.ajax({
                        url: Glizy.ajaxUrl + '&controllerName=metafad.tei.controllers.ajax.Delete',
                        type: 'get',
                        action: 'delete',
                        dataType: 'json',
                        data: {
