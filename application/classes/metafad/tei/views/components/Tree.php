...
class metafad_tei_views_components_Tree  extends org_glizy_components_Component
{
    /**
     * Init
     *
...
class metafad_tei_views_components_Tree_render extends org_glizy_components_render_Render
{
