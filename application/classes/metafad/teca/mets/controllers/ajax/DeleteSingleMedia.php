<?php
class metafad_teca_mets_controllers_ajax_DeleteSingleMedia extends metafad_common_controllers_ajax_CommandAjax
{
    public function execute($id)
    {
      ...
      $it = org_glizy_ObjectFactory::createModelIterator('metafad.teca.mets.models.Publication')
