<?php
class metafad_teca_mets_views_components_AddButton extends org_glizy_components_Component
{
    function init()
    {
        ...
        $this->defineAttribute('add', false, 'Aggiungi METS', COMPONENT_TYPE_STRING);
