<?php
class metafad_teca_MAG_views_components_ShowFiles extends org_glizy_components_Component
{
  function init()
  {
  ...
  function render()
  {
    if(__Request::get('id'))
    {
      ...
      if($rootId)
      {
        $it = org_glizy_ObjectFactory::createModelIterator('metafad.teca.MAG.models.'.$type)
