<?php
class metafad_teca_STRUMAG_views_components_AddButton extends org_glizy_components_Component
{
    function init()
    {
        ...
        $this->defineAttribute('add', false, 'Aggiungi metadato', COMPONENT_TYPE_STRING);
