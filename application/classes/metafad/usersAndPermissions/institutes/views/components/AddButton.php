<?php
class metafad_usersAndPermissions_institutes_views_components_AddButton extends org_glizy_components_Component
{
    function init()
    {
    ...
    function render()
    {
        ...
        $output = '<div id="dataGridAddButton"><div class="btn-group btn-right-accessory">'.
            '</div>'.__Link::makeLink($routeUrl, array('label' => " Aggiungi istituto", 'cssClass' => 'btn btn-info btn-flat btn-add', 'icon' => 'plusIcon fa fa-plus')).'</div>';
