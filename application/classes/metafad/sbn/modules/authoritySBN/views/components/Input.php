 ...
 */
class metafad_sbn_modules_authoritySBN_views_components_Input extends org_glizy_components_HtmlFormElement
{
    /**
     * Init
     *
    ...
    function render_html()
    {
        ...
        if ($this->_content && (count($this->_content)) != 1) {
            ...
            foreach ($this->_content as $content) {
                ...
                if($count == 0){
                    $output = '<div ' . $this->_renderAttributes($attributes) . '/>' . htmlentities($content) . '</div>';
